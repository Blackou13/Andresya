...
AddEventHandler('ogBj:baseJumpingCharge', function()
	...
	TriggerClientEvent("pNotify:SendNotification", _source, {text = "<center><strong><b style='color:#B2FF33'>Base Jumping Notification</b><strong><br /> <br /> Vous avez payé 50 $ pour couvrir le coût du parachute ... N'hésitez pas à sauter !<center>", type = "success", queue = "global", timeout = 5000, layout = "centerRight" })
	xPlayer.removeMoney(50)
	
	else 
	
	TriggerClientEvent("pNotify:SendNotification", _source, {text = "<center><strong><b style='color:#B2FF33'>Base Jumping Notification</b><strong><br /> <br /> Tu n'as pas assez d'argent.", type = "success", queue = "global", timeout = 5000, layout = "centerRight" })
	
	end
	
	else
	
	TriggerClientEvent("pNotify:SendNotification", _source, {text = "<center><strong><b style='color:#B2FF33'>Base Jumping Notification</b><strong><br /> <br /> On vous a fourni un parachute ... N'hésitez pas à sauter !<center>", type = "success", queue = "global", timeout = 5000, layout = "centerRight" })
