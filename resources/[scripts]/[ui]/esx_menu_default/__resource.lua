...
files {
	...
	'html/img/header/wez.png',
	'html/img/header/agence.png',
	'html/img/header/gouv.png',
	'html/img/header/concess.png',
	'html/img/header/vigne.png',
	'html/img/header/securite.png',
	'html/img/header/tabac.png',
	'html/img/header/taxi.png',
	'html/img/header/unicorn.png',
	'html/img/header/licence.png',
