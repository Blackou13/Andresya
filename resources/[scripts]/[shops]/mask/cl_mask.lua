...
function OpenMask()
	TriggerEvent("dqp:exit")
		local maskShop = NativeUI.CreateMenu("", "Magasin de masques", 5, 100,"shopui_title_movie_masks","shopui_title_movie_masks")
...
function OpenMenuMask()
	...
	ESX.TriggerServerCallback("dqp:getMask", function(result2)
		...
		local SkurtShop = NativeUI.CreateMenu("", "Mes masques", 5, 100,"shopui_title_movie_masks","shopui_title_movie_masks")
...
AddEventHandler('Mask:hasEnteredMarker', function(zone)
	...
	CurrentAction66Msg  = 'Appui sur ~INPUT_CONTEXT~ pour ouvrir le magasin'
...
Citizen.CreateThread(function()
        ...
        AddTextComponentString("Boutique de masque")
