...
local atms = {
	{name="ATM", id=277, x=-1391.020, y=-590.3592, z=30.3195},
	{name="ATM", id=277, x=-386.733, y=6045.953, z=31.501},
	{name="ATM", id=277, x=-38.84, y=-1118.82, z=26.502},
	...
	{name="ATM", id=277, x=250.150, y=-791.570, z=30.404},
	{name="ATM", id=277, x=-2114.8405, y=-478.5404, z=12.84},
...
if bankMenu then
	...
	if nearBank() or nearATM() then
			DisplayHelpText("Appuie sur ~INPUT_PICKUP~ pour accéder à tes comptes ~b~")
