  ...
  ESX.UI.Menu.Open(
	...
	TriggerEvent('esx_skin:openRestrictedMenu', function(data, menu)
		...
		ESX.UI.Menu.Open(
			...
			function(data, menu)
				...
				if data.current.value == 'yes' then
					...
					ESX.TriggerServerCallback('El_clotheshop:checkMoney', function(hasEnoughMoney)
						...
						if hasEnoughMoney then
							...
							TriggerServerEvent('El_clotheshop:pay')

							HasPayed = true

							ESX.TriggerServerCallback('El_clotheshop:checkPropertyDataStore', function(foundStore)
											...
											if data2.current.value == 'yes' then
												...
												ESX.UI.Menu.Open(
													...
													function(data3, menu3)
														...
														TriggerEvent('skinchanger:getSkin', function(skin)
															TriggerServerEvent('El_clotheshop:saveOutfit', data3.value, skin)
														end)
      ...
      if data.current.value == 'player_dressing' then
        ...
        ESX.TriggerServerCallback('El_clotheshop:getPlayerDressing', function(dressing)
          ...
          ESX.UI.Menu.Open(
            ...
            function(data, menu)
              ...
              TriggerEvent('skinchanger:getSkin', function(skin)
                ...
                ESX.TriggerServerCallback('El_clotheshop:getPlayerOutfit', function(clothes)
	  ...
	  if data.current.value == 'suppr_cloth' then
		ESX.TriggerServerCallback('El_clotheshop:getPlayerDressing', function(dressing)
            ...
            function(data, menu)
			menu.close()
				TriggerServerEvent('El_clotheshop:deleteOutfit', data.current.value)
...
AddEventHandler('El_clotheshop:hasEnteredMarker', function(zone)
	CurrentAction     = 'shop_menu'
	CurrentActionMsg  = _U('press_menu')
	CurrentActionData = {}
end)

AddEventHandler('El_clotheshop:hasExitedMarker', function(zone)
...
Citizen.CreateThread(function()
	while true do
		...
		if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
			...
			TriggerEvent('El_clotheshop:hasEnteredMarker', currentZone)
		end

		if not isInMarker and HasAlreadyEnteredMarker then
			HasAlreadyEnteredMarker = false
			TriggerEvent('El_clotheshop:hasExitedMarker', LastZone)
		end
