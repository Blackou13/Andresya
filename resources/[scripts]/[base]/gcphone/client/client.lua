...
RegisterNetEvent('gcphone:callServerNumber')
AddEventHandler('gcphone:callServerNumber', function(data)
  TriggerServerEvent('gcphone:CallServerNumber', data.number)
end)
...
RegisterNUICallback('sendMessage', function(data, cb)
  ...
  TriggerServerEvent("logs:BasicLogs","Téléphone" ,"nouveau message à  " ..  data.phoneNumber .. " " .. data.message ,"infos")
