...
RegisterServerEvent("esx_ammujob:showLicence1")
AddEventHandler("esx_ammujob:showLicence1", function(money)
	
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local result = MySQL.Sync.fetchAll("SELECT * FROM users WHERE identifier=@jobname;", {
        ['@jobname'] = xPlayer.identifier
	})
	if result[1].licence1 == 1 then
		TriggerClientEvent('esx:showNotification', money, "Ammunation : Licence 1")
	end
end)

RegisterServerEvent("esx_ammujob:showLicence2")
AddEventHandler("esx_ammujob:showLicence2", function(money)
	...
	if result[1].licence2 == 1 then
		TriggerClientEvent('esx:showNotification', money, "Ammunation : Licence 2")
	end
end)
RegisterServerEvent("esx_ammujob:showLicence3")
AddEventHandler("esx_ammujob:showLicence3", function(money)
	...
	if result[1].licence3 == 1 then
		TriggerClientEvent('esx:showNotification', money, "Ammunation : Licence 3")
	end
end)
