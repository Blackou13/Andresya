									...
									function(data3, menu3)
										...
										if data3.current.value == 'licence_1' then
											...
											if distance ~= -1 and distance <= 3.0 then
												TriggerServerEvent('esx_ammujob:showLicence1', GetPlayerServerId(player))
											end
										end
										...
										if data3.current.value == 'licence_2' then
											...
											if distance ~= -1 and distance <= 3.0 then
												TriggerServerEvent('esx_ammujob:showLicence2', GetPlayerServerId(player))
											end
										end
										...
										if data3.current.value == 'licence_3' then
											...
											if distance ~= -1 and distance <= 3.0 then
												TriggerServerEvent('esx_ammujob:showLicence3', GetPlayerServerId(player))
											end
										end
