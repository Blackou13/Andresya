Locales['fr'] = {
    ...
    ['press_collect_coke'] = 'appuyez sur ~INPUT_CONTEXT~ pour récolter la Feuille de Coca',
    ['press_process_coke'] = 'appuyez sur ~INPUT_CONTEXT~ pour traiter le Pavot',
    ['press_sell_coke'] = 'appuyez sur ~INPUT_CONTEXT~ pour vendre le Cocaïne',
    ...
    ['inv_full_coke'] = 'vous ne pouvez plus ramasser de Feuille de Coca, votre inventaire est ~r~plein~s~',
    ['pickup_in_prog'] = '~y~Ramassage en cours~s~...',
    ['too_many_pouches'] = 'vous avez trop de Pavot',
    ['not_enough_coke'] = 'vous n\'avez pas assez de Feuille de Coca à ~r~conditionner~s~',
    ['packing_in_prog'] = '~y~Conditonnement en cours~s~...',
    ['no_pouches_sale'] = 'vous n\'avez plus de Pavot à ~r~vendre~s~',
    ['sold_one_coke'] = 'vous avez vendu ~g~x1 Pavot~s~',
