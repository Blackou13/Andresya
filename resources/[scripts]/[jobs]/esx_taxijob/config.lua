...
Config.NPCJobEarnings             = {min = 100, max = 120}
...
Config.Zones = {
	...
	VehicleSpawnPoint = {
		Pos     = {x = 902.502, y = -142.01, z = 76.63},
		Size    = {x = 1.5, y = 1.5, z = 1.0},
		Type    = -1,
		Heading = 330.0
	},
	...
	TaxiActions = {
		Pos   = {x = -150.06, y = -955.17, z = 219.126},
		Size  = {x = 1.5, y = 1.5, z = 1.0},
		Color = {r = 204, g = 204, b = 0},
		Type  = 1
	},
	...
	Cloakroom = {
		Pos     = {x = -151.21, y = -960.89, z = 219.12},
		Size    = {x = 1.5, y = 1.5, z = 1.0},
		Color   = {r = 204, g = 204, b = 0},
		Type    = 1
	}
