...
Config.Zones = {
	...
	MecanoActions = {
		Pos   = {x = -206.017, y = -1327.61, z = 30.89 },
		Size  = {x = 1.5, y = 1.5, z = 1.0},
		Color = {r = 204, g = 204, b = 0},
		Type  = 1
	},
	...
	BossActions = {
		Pos   = {x = -206.64, y = -1341.58, z = 34.89},
		Size  = {x = 1.5, y = 1.5, z = 1.0},
		Color = {r = 204, g = 204, b = 0},
		Type  = 1
	},
	...
	VehicleSpawnPoint = {
		Pos   = {x = -159.22, y = -1306.00, z = 31.34 },
		Size  = {x = 1.5, y = 1.5, z = 1.0},
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = {x = -193.08, y = -1289.52, z = 31.29 },
	...
	VehicleDelivery = {
		Pos   = {x = -180.88, y = -1323.84, z = 31.26},
