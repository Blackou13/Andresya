        ...
        ESX.UI.Menu.Open(
		  ...
		  css = 'ammu',
            ...
            elements = {
              ...
              {label = 'Donner la licence 1',            value = 'licence1'},
              {label = 'Donner la licence 2',            value = 'licence2'},
              {label = 'Donner la licence 3',            value = 'licence3'},
              
              {label = 'Retirer la licence 1',            value = 'rlicence1'},
              {label = 'Retirer la licence 2',            value = 'rlicence2'},
              {label = 'Retirer la licence 3',            value = 'rlicence3'},
            },
          },
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'licence1' then
                TriggerServerEvent('esx_ammujob:licence1', GetPlayerServerId(player))
              end
              if data2.current.value == 'licence2' then
                TriggerServerEvent('esx_ammujob:licence2', GetPlayerServerId(player))
              end
              if data2.current.value == 'licence3' then
                TriggerServerEvent('esx_ammujob:licence3', GetPlayerServerId(player))
              end

              if data2.current.value == 'rlicence1' then
                TriggerServerEvent('esx_ammujob:rlicence1', GetPlayerServerId(player))
              end
              if data2.current.value == 'rlicence2' then
                TriggerServerEvent('esx_ammujob:rlicence2', GetPlayerServerId(player))
              end
              if data2.current.value == 'rlicence3' then
                TriggerServerEvent('esx_ammujob:rlicence3', GetPlayerServerId(player))
              end
