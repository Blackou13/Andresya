Locales['fr'] = {
  ...
  -- Death
  ['please_wait'] = 'Veuillez patienter ~b~%s minutes %s secondes~s~\n',
  ['press_respawn'] = 'Appui sur [~b~E~w~] pour réapparaître.',
  ['respawn_now_fine'] = 'Vous pouvez désormais réapparaître en appuyant sur [E]',
  ['respawn_fine'] = 'Tu as ~r~$%s~s~ pour réapparaître.',
  ['distress_send'] = '',
