Locales['en'] = {
  ...
  ['vehicle_belongs']         = 'Le véhicule~y~%s~s~ appartient maintenant à ~b~you~s~',
  ...
  ['shop_menu']               = 'Appuie sur ~INPUT_CONTEXT~ pour accéder au menu',
  ...
  ['inventory']               = 'inventory',
  ['dealership']              = 'Concessionnaire bateaux',
