	...
	Citizen.CreateThread(function()
		while true do
			...
			if displayHud then
				...
				DrawAdvancedText(0.190 - x, 0.77 - y, 0.005, 0.0028, 0.55, fuel, 255, 255, 255, 255, 6, 1)
				DrawAdvancedText(0.148 - x, 0.7725 - y, 0.005, 0.0028, 0.5, "ESSENCE :         LITRES", 255, 255, 255, 255, 6, 1)
			else
				Citizen.Wait(750)
			end
		end
