...
repairCfg = {
	...
	fixMessages = {
		"Vous remettez le bouchon d'huile dessus",
		"Vous avez arrêté la fuite d'huile avec du chewing-gum",
		"Vous réparez le tube d'huile avec du ruban adhésif",
	...
	noFixMessages = {
		...
		"Vous avez augmenté le volume de la radio. Il vient de noyer le bruit étrange du moteur qui maintient le moteur en place",
